...
public final class WidgetUpdateExtraCDRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public emu.grasscutter.net.proto.WidgetExtraCdTypeOuterClass.WidgetExtraCdType getExtraCdType() {
      emu.grasscutter.net.proto.WidgetExtraCdTypeOuterClass.WidgetExtraCdType result = emu.grasscutter.net.proto.WidgetExtraCdTypeOuterClass.WidgetExtraCdType.forNumber(extraCdType_);
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.WidgetUpdateExtraCDRspOuterClass.WidgetUpdateExtraCDRsp result) {
      ...
      public Builder mergeCoolData(emu.grasscutter.net.proto.WidgetCoolDownDataOuterClass.WidgetCoolDownData value) {
        if (coolDataBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            coolData_ != null &&
            coolData_ != emu.grasscutter.net.proto.WidgetCoolDownDataOuterClass.WidgetCoolDownData.getDefaultInstance()) {
