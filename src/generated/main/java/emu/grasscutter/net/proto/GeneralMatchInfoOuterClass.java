...
public final class GeneralMatchInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo result) {
        if (playerListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GeneralMatchInfoOuterClass.GeneralMatchInfo result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 98: {
                emu.grasscutter.net.proto.MatchPlayerInfoOuterClass.MatchPlayerInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.MatchPlayerInfoOuterClass.MatchPlayerInfo.parser(),
                        extensionRegistry);
                if (playerListBuilder_ == null) {
                  ensurePlayerListIsMutable();
                  playerList_.add(m);
