...
public final class RegionalPlayInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.RegionalPlayInfoNotifyOuterClass.RegionalPlayInfoNotify result) {
        if (varListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.RegionalPlayInfoNotifyOuterClass.RegionalPlayInfoNotify result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 106: {
                emu.grasscutter.net.proto.RegionalPlayVarOuterClass.RegionalPlayVar m =
                    input.readMessage(
                        emu.grasscutter.net.proto.RegionalPlayVarOuterClass.RegionalPlayVar.parser(),
                        extensionRegistry);
                if (varListBuilder_ == null) {
                  ensureVarListIsMutable();
                  varList_.add(m);
