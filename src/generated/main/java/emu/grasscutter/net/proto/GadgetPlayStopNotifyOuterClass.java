...
public final class GadgetPlayStopNotifyOuterClass {
  ...
  public interface GadgetPlayStopNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .GadgetPlayUidInfo uid_info_list = 1;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.GadgetPlayStopNotifyOuterClass.GadgetPlayStopNotify result) {
        if (uidInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GadgetPlayStopNotifyOuterClass.GadgetPlayStopNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.GadgetPlayUidInfoOuterClass.GadgetPlayUidInfo.parser(),
                        extensionRegistry);
                if (uidInfoListBuilder_ == null) {
                  ensureUidInfoListIsMutable();
                  uidInfoList_.add(m);
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\ruid_info_list\030\001 \003(\0132\022.GadgetPlayUidInf" +
      "o\022\021\n\tplay_type\030\003 \001(\r\022\016\n\006is_win\030\010 \001(\010\022\021\n\t" +
    ...
    internal_static_GadgetPlayStopNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GadgetPlayStopNotify_descriptor,
        new java.lang.String[] { "UidInfoList", "PlayType", "IsWin", "EntityId", "Score", "CostTime", });
    emu.grasscutter.net.proto.GadgetPlayUidInfoOuterClass.getDescriptor();
  }
