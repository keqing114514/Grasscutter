...
public final class RemotePlayerWidgetNotifyOuterClass {
  ...
  public interface RemotePlayerWidgetNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayerWidgetInfo player_widget_info_list = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PLAYER_WIDGET_INFO_LIST_FIELD_NUMBER = 10;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playerWidgetInfoList_.size(); i++) {
        output.writeMessage(10, playerWidgetInfoList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playerWidgetInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, playerWidgetInfoList_.get(i));
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.RemotePlayerWidgetNotifyOuterClass.RemotePlayerWidgetNotify result) {
        if (playerWidgetInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.RemotePlayerWidgetNotifyOuterClass.RemotePlayerWidgetNotify result) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tify\0222\n\027player_widget_info_list\030\n \003(\0132\021." +
