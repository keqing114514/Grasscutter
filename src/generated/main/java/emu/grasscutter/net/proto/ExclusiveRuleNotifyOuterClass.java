...
public final class ExclusiveRuleNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ExclusiveRuleNotifyOuterClass.ExclusiveRuleNotify result) {
        if (ruleInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ExclusiveRuleNotifyOuterClass.ExclusiveRuleNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.parser(),
                        extensionRegistry);
                if (ruleInfoListBuilder_ == null) {
                  ensureRuleInfoListIsMutable();
                  ruleInfoList_.add(m);
