...
public final class ActivityGetRecvGiftListRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp result) {
        if (recvGiftListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ActivityGetRecvGiftListRspOuterClass.ActivityGetRecvGiftListRsp result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 82: {
                emu.grasscutter.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ActivityRecvGiftDataOuterClass.ActivityRecvGiftData.parser(),
                        extensionRegistry);
                if (recvGiftListBuilder_ == null) {
                  ensureRecvGiftListIsMutable();
                  recvGiftList_.add(m);
