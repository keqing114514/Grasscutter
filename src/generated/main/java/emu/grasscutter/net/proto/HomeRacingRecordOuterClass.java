...
public final class HomeRacingRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.HomeRacingRecordOuterClass.HomeRacingRecord result) {
        if (recordListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.HomeRacingRecordOuterClass.HomeRacingRecord result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.HomeRacingGalleryRecordOuterClass.HomeRacingGalleryRecord m =
                    input.readMessage(
                        emu.grasscutter.net.proto.HomeRacingGalleryRecordOuterClass.HomeRacingGalleryRecord.parser(),
                        extensionRegistry);
                if (recordListBuilder_ == null) {
                  ensureRecordListIsMutable();
                  recordList_.add(m);
