...
public final class ChessEntranceDetailInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ChessEntranceDetailInfoOuterClass.ChessEntranceDetailInfo result) {
        if (infoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ChessEntranceDetailInfoOuterClass.ChessEntranceDetailInfo result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo.parser(),
                        extensionRegistry);
                if (infoListBuilder_ == null) {
                  ensureInfoListIsMutable();
                  infoList_.add(m);
