...
public final class HomeGetGroupRecordRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (groupRecord_ != null) {
        output.writeMessage(6, getGroupRecord());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (groupRecord_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, getGroupRecord());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.HomeGetGroupRecordRspOuterClass.HomeGetGroupRecordRsp result) {
      ...
      public Builder mergeGroupRecord(emu.grasscutter.net.proto.HomeGroupRecordOuterClass.HomeGroupRecord value) {
        if (groupRecordBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0) &&
            groupRecord_ != null &&
            groupRecord_ != emu.grasscutter.net.proto.HomeGroupRecordOuterClass.HomeGroupRecord.getDefaultInstance()) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\014group_record\030\006 \001(\0132\020.HomeGroupRecord\022\017\n" +
