...
public final class AranaraCollectionDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < collectionSuiteList_.size(); i++) {
        output.writeMessage(15, collectionSuiteList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < collectionSuiteList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(15, collectionSuiteList_.get(i));
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.AranaraCollectionDataNotifyOuterClass.AranaraCollectionDataNotify result) {
        if (collectionSuiteListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AranaraCollectionDataNotifyOuterClass.AranaraCollectionDataNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite m =
                    input.readMessage(
                        emu.grasscutter.net.proto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.parser(),
                        extensionRegistry);
                if (collectionSuiteListBuilder_ == null) {
                  ensureCollectionSuiteListIsMutable();
                  collectionSuiteList_.add(m);
                } else {
                  collectionSuiteListBuilder_.addMessage(m);
                }
                break;
              } // case 122
              default: {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\017 \003(\0132\027.AranaraCollectionSuiteB\033\n\031emu." +
