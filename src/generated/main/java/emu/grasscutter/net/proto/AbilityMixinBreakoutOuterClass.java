...
public final class AbilityMixinBreakoutOuterClass {
  ...
  public interface AbilityMixinBreakoutOrBuilder extends
    ...
    /**
     * <code>.BreakoutSyncCreateConnect sync_create_connect = 2;</code>
    ...
    /**
     * <code>.BreakoutSyncFinishGame sync_finish_game = 5;</code>
    ...
    /**
     * <code>.BreakoutSyncSnapShot sync_snap_shot = 14;</code>
    ...
    /**
     * <code>.BreakoutSyncAction sync_action = 3;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum SyncCase
      ...
      public static SyncCase forNumber(int value) {
        switch (value) {
          case 2: return SYNC_CREATE_CONNECT;
          case 1: return SYNC_PING;
          case 5: return SYNC_FINISH_GAME;
    ...
    @java.lang.Override public emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType getSyncType() {
      emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType result = emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType.forNumber(syncType_);
    ...
    public static final int SYNC_CREATE_CONNECT_FIELD_NUMBER = 2;
    /**
     * <code>.BreakoutSyncCreateConnect sync_create_connect = 2;</code>
     * @return Whether the syncCreateConnect field is set.
     */
    ...
    public static final int SYNC_FINISH_GAME_FIELD_NUMBER = 5;
    /**
     * <code>.BreakoutSyncFinishGame sync_finish_game = 5;</code>
     * @return Whether the syncFinishGame field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (syncCase_ == 1) {
        output.writeMessage(1, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncCase_ == 2) {
        output.writeMessage(2, (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect) sync_);
      }
      if (syncCase_ == 3) {
        output.writeMessage(3, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      ...
      if (syncCase_ == 5) {
        output.writeMessage(5, (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame) sync_);
      }
      if (retcode_ != 0) {
        output.writeInt32(8, retcode_);
      }
      if (syncCase_ == 14) {
        output.writeMessage(14, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (syncCase_ == 1) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1, (emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPing) sync_);
      }
      if (syncCase_ == 2) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, (emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnect) sync_);
      }
      if (syncCase_ == 3) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, (emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncAction) sync_);
      }
      if (syncType_ != emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout.SyncType.SYNC_TYPE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (syncCase_ == 5) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, (emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGame) sync_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (syncCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShot) sync_);
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout result) {
      ...
      private void buildPartialOneofs(emu.grasscutter.net.proto.AbilityMixinBreakoutOuterClass.AbilityMixinBreakout result) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncCreateConnectOuterClass.BreakoutSyncCreateConnectOrBuilder getSyncCreateConnectOrBuilder() {
        if ((syncCase_ == 2) && (syncCreateConnectBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncPingOuterClass.BreakoutSyncPingOrBuilder getSyncPingOrBuilder() {
        if ((syncCase_ == 1) && (syncPingBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncFinishGameOuterClass.BreakoutSyncFinishGameOrBuilder getSyncFinishGameOrBuilder() {
        if ((syncCase_ == 5) && (syncFinishGameBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncSnapShotOuterClass.BreakoutSyncSnapShotOrBuilder getSyncSnapShotOrBuilder() {
        if ((syncCase_ == 14) && (syncSnapShotBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.BreakoutSyncActionOuterClass.BreakoutSyncActionOrBuilder getSyncActionOrBuilder() {
        if ((syncCase_ == 3) && (syncActionBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tcode\030\010 \001(\005\0221\n\tsync_type\030\004 \001(\0162\036.Ability" +
      "MixinBreakout.SyncType\0229\n\023sync_create_co" +
      "nnect\030\002 \001(\0132\032.BreakoutSyncCreateConnectH" +
      "\000\022&\n\tsync_ping\030\001 \001(\0132\021.BreakoutSyncPingH" +
      "\000\0223\n\020sync_finish_game\030\005 \001(\0132\027.BreakoutSy" +
      "ncFinishGameH\000\022/\n\016sync_snap_shot\030\016 \001(\0132\025" +
      ".BreakoutSyncSnapShotH\000\022*\n\013sync_action\030\003" +
