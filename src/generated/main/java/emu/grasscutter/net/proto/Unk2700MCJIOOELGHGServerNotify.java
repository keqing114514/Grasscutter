...
public final class Unk2700MCJIOOELGHGServerNotify {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.Unk2700MCJIOOELGHGServerNotify.Unk2700_MCJIOOELGHG_ServerNotify result) {
        if (unk2700KBMKGNGFGFOBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.Unk2700MCJIOOELGHGServerNotify.Unk2700_MCJIOOELGHG_ServerNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 50: {
                emu.grasscutter.net.proto.Unk2700JDPMOMKAPIF.Unk2700_JDPMOMKAPIF m =
                    input.readMessage(
                        emu.grasscutter.net.proto.Unk2700JDPMOMKAPIF.Unk2700_JDPMOMKAPIF.parser(),
                        extensionRegistry);
                if (unk2700KBMKGNGFGFOBuilder_ == null) {
                  ensureUnk2700KBMKGNGFGFOIsMutable();
