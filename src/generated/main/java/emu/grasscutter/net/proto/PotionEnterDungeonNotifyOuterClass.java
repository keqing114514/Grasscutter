...
public final class PotionEnterDungeonNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.PotionEnterDungeonNotifyOuterClass.PotionEnterDungeonNotify result) {
        if (dungeonAvatarListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.PotionEnterDungeonNotifyOuterClass.PotionEnterDungeonNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.proto.PotionDungeonAvatarOuterClass.PotionDungeonAvatar m =
                    input.readMessage(
                        emu.grasscutter.net.proto.PotionDungeonAvatarOuterClass.PotionDungeonAvatar.parser(),
                        extensionRegistry);
                if (dungeonAvatarListBuilder_ == null) {
                  ensureDungeonAvatarListIsMutable();
