...
public final class BlessingGetAllRecvPicRecordListRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass.BlessingGetAllRecvPicRecordListRsp result) {
        if (recvPicRecordListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.BlessingGetAllRecvPicRecordListRspOuterClass.BlessingGetAllRecvPicRecordListRsp result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord m =
                    input.readMessage(
                        emu.grasscutter.net.proto.BlessingRecvPicRecordOuterClass.BlessingRecvPicRecord.parser(),
                        extensionRegistry);
                if (recvPicRecordListBuilder_ == null) {
                  ensureRecvPicRecordListIsMutable();
