...
public final class HomeBalloonRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.HomeBalloonRecordOuterClass.HomeBalloonRecord result) {
        if (recordListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.HomeBalloonRecordOuterClass.HomeBalloonRecord result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 122: {
                emu.grasscutter.net.proto.HomeBalloonGalleryRecordOuterClass.HomeBalloonGalleryRecord m =
                    input.readMessage(
                        emu.grasscutter.net.proto.HomeBalloonGalleryRecordOuterClass.HomeBalloonGalleryRecord.parser(),
                        extensionRegistry);
                if (recordListBuilder_ == null) {
                  ensureRecordListIsMutable();
                  recordList_.add(m);
