...
public final class ActivityAcceptAllGiveGiftRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        output.writeMessage(7, acceptGiftResultInfoList_.get(i));
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < acceptGiftResultInfoList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, acceptGiftResultInfoList_.get(i));
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ActivityAcceptAllGiveGiftRspOuterClass.ActivityAcceptAllGiveGiftRsp result) {
        if (acceptGiftResultInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ActivityAcceptAllGiveGiftRspOuterClass.ActivityAcceptAllGiveGiftRsp result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                emu.grasscutter.net.proto.ActivityAcceptGiftResultInfoOuterClass.ActivityAcceptGiftResultInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ActivityAcceptGiftResultInfoOuterClass.ActivityAcceptGiftResultInfo.parser(),
                        extensionRegistry);
                if (acceptGiftResultInfoListBuilder_ == null) {
                  ensureAcceptGiftResultInfoListIsMutable();
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_result_info_list\030\007 \003(\0132\035.ActivityAccept" +
