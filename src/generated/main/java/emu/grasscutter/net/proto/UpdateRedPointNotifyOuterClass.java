...
public final class UpdateRedPointNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify result) {
        if (redPointListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.UpdateRedPointNotifyOuterClass.UpdateRedPointNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 82: {
                emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.RedPointDataOuterClass.RedPointData.parser(),
                        extensionRegistry);
                if (redPointListBuilder_ == null) {
                  ensureRedPointListIsMutable();
                  redPointList_.add(m);
