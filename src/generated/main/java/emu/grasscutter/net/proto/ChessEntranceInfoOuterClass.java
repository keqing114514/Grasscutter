...
public final class ChessEntranceInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo result) {
        if (monsterInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.ChessEntranceInfoOuterClass.ChessEntranceInfo result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 122: {
                emu.grasscutter.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.ChessMonsterInfoOuterClass.ChessMonsterInfo.parser(),
                        extensionRegistry);
                if (monsterInfoListBuilder_ == null) {
                  ensureMonsterInfoListIsMutable();
