...
public final class RogueDiaryAvatarOuterClass {
  ...
  private static final long serialVersionUID = 0L;
        ...
        java.lang.Integer, emu.grasscutter.net.proto.RogueDiaryAvatarDisableStatusOuterClass.RogueDiaryAvatarDisableStatus> disableStatusList_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
              ...
              public emu.grasscutter.net.proto.RogueDiaryAvatarDisableStatusOuterClass.RogueDiaryAvatarDisableStatus convert(java.lang.Integer from) {
                emu.grasscutter.net.proto.RogueDiaryAvatarDisableStatusOuterClass.RogueDiaryAvatarDisableStatus result = emu.grasscutter.net.proto.RogueDiaryAvatarDisableStatusOuterClass.RogueDiaryAvatarDisableStatus.forNumber(from);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (tiredRound_ != 0) {
        output.writeUInt32(2, tiredRound_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (tiredRound_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, tiredRound_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < disableStatusList_.size(); i++) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar result) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.RogueDiaryAvatarOuterClass.RogueDiaryAvatar result) {
      ...
      public Builder mergeAvatar(emu.grasscutter.net.proto.ActivityDungeonAvatarOuterClass.ActivityDungeonAvatar value) {
        if (avatarBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            avatar_ != null &&
            avatar_ != emu.grasscutter.net.proto.ActivityDungeonAvatarOuterClass.ActivityDungeonAvatar.getDefaultInstance()) {
  ...
  static {
    ...
    internal_static_RogueDiaryAvatar_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_RogueDiaryAvatar_descriptor,
        new java.lang.String[] { "Level", "DisableStatusList", "TiredRound", "Avatar", });
    emu.grasscutter.net.proto.ActivityDungeonAvatarOuterClass.getDescriptor();
    emu.grasscutter.net.proto.RogueDiaryAvatarDisableStatusOuterClass.getDescriptor();
  }
