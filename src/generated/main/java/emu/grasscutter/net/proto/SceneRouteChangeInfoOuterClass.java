...
public final class SceneRouteChangeInfoOuterClass {
  ...
  public interface SceneRouteChangeInfoOrBuilder extends
    ...
    /**
     * <code>repeated .RoutePointChangeInfo point_list = 10;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < pointList_.size(); i++) {
        output.writeMessage(10, pointList_.get(i));
      }
      if (type_ != 0) {
      ...
      if (isForward_ != false) {
        output.writeBool(15, isForward_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < pointList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(10, pointList_.get(i));
      }
      if (type_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\022\n\nis_forward\030\017 \001(\010\022\014\n\004type\030\013 \001(\r\022)\n\npo" +
      "int_list\030\n \003(\0132\025.RoutePointChangeInfo\022\020\n" +
      "\010route_id\030\014 \001(\rB\033\n\031emu.grasscutter.net.p" +
      "rotob\006proto3"
    };
    ...
    internal_static_SceneRouteChangeInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneRouteChangeInfo_descriptor,
        new java.lang.String[] { "IsForward", "Type", "PointList", "RouteId", });
    emu.grasscutter.net.proto.RoutePointChangeInfoOuterClass.getDescriptor();
  }
