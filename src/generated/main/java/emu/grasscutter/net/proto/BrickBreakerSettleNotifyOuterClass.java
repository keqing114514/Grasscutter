...
public final class BrickBreakerSettleNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify.SettleReason getReason() {
      emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify.SettleReason result = emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify.SettleReason.forNumber(reason_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (isDungeon_ != false) {
        output.writeBool(2, isDungeon_);
      }
      if (isNewRecord_ != false) {
        output.writeBool(3, isNewRecord_);
      }
      for (int i = 0; i < updateSkillList_.size(); i++) {
        output.writeMessage(4, updateSkillList_.get(i));
      }
      if (time_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < updateSkillList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, updateSkillList_.get(i));
      }
      if (time_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify result) {
        if (updateSkillListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.BrickBreakerSettleNotifyOuterClass.BrickBreakerSettleNotify result) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\014\n\004time\030\005 \001(\r\022\026\n\016is_single_mode\030\017 \001(\010\022\022\n" +
      "\nis_dungeon\030\002 \001(\010\022\r\n\005score\030\007 \001(\r\022\r\n\005comb" +
      "o\030\014 \001(\r\022\020\n\010level_id\030\013 \001(\r\0226\n\006reason\030\001 \001(" +
      "\0162&.BrickBreakerSettleNotify.SettleReaso" +
      "n\022\025\n\ris_new_record\030\003 \001(\010\022\022\n\ngallery_id\030\r" +
      " \001(\r\022&\n\021update_skill_list\030\004 \003(\0132\013.Uint32" +
    ...
    internal_static_BrickBreakerSettleNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BrickBreakerSettleNotify_descriptor,
        new java.lang.String[] { "Time", "IsSingleMode", "IsDungeon", "Score", "Combo", "LevelId", "Reason", "IsNewRecord", "GalleryId", "UpdateSkillList", });
    emu.grasscutter.net.proto.Uint32PairOuterClass.getDescriptor();
  }
