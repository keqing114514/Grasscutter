...
public final class AbilityMixinWindSeedSpawnerOuterClass {
  ...
  public interface AbilityMixinWindSeedSpawnerOrBuilder extends
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 8;</code>
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.RefreshSeed refresh_seed = 12;</code>
    ...
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 14;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        private void buildPartialRepeatedFields(emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed result) {
          if (posListBuilder_ == null) {
        ...
        private void buildPartial0(emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed result) {
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed result) {
          int from_bitField0_ = bitField0_;
    ...
    public enum CmdCase
      ...
      public static CmdCase forNumber(int value) {
        switch (value) {
          case 8: return ADD_SIGNAL;
          case 12: return REFRESH_SEED;
          case 14: return CATCH_SEED;
    ...
    public static final int ADD_SIGNAL_FIELD_NUMBER = 8;
    /**
     * <code>.AbilityMixinWindSeedSpawner.AddSignal add_signal = 8;</code>
     * @return Whether the addSignal field is set.
     */
    ...
    public static final int REFRESH_SEED_FIELD_NUMBER = 12;
    /**
     * <code>.AbilityMixinWindSeedSpawner.RefreshSeed refresh_seed = 12;</code>
     * @return Whether the refreshSeed field is set.
     */
    ...
    public static final int CATCH_SEED_FIELD_NUMBER = 14;
    /**
     * <code>.AbilityMixinWindSeedSpawner.CatchSeed catch_seed = 14;</code>
     * @return Whether the catchSeed field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (cmdCase_ == 8) {
        output.writeMessage(8, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      if (cmdCase_ == 12) {
        output.writeMessage(12, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      if (cmdCase_ == 14) {
        output.writeMessage(14, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (cmdCase_ == 8) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignal) cmd_);
      }
      if (cmdCase_ == 12) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeed) cmd_);
      }
      if (cmdCase_ == 14) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(14, (emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeed) cmd_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner result) {
        int from_bitField0_ = bitField0_;
      }

      private void buildPartialOneofs(emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner result) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.AddSignalOrBuilder getAddSignalOrBuilder() {
        if ((cmdCase_ == 8) && (addSignalBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.RefreshSeedOrBuilder getRefreshSeedOrBuilder() {
        if ((cmdCase_ == 12) && (refreshSeedBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.AbilityMixinWindSeedSpawnerOuterClass.AbilityMixinWindSeedSpawner.CatchSeedOrBuilder getCatchSeedOrBuilder() {
        if ((cmdCase_ == 14) && (catchSeedBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r\022<\n\nadd_signal\030\010 \001(\0132&.AbilityMixinWind" +
      "SeedSpawner.AddSignalH\000\022@\n\014refresh_seed\030" +
      "\014 \001(\0132(.AbilityMixinWindSeedSpawner.Refr" +
      "eshSeedH\000\022<\n\ncatch_seed\030\016 \001(\0132&.AbilityM" +
      "ixinWindSeedSpawner.CatchSeedH\000\032\013\n\tAddSi" +
      "gnal\032(\n\013RefreshSeed\022\031\n\010pos_list\030\n \003(\0132\007." +
      "Vector\032\036\n\tCatchSeed\022\021\n\tentity_id\030\r \001(\rB\005" +
