...
public final class PlayerOfferingDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.PlayerOfferingDataNotifyOuterClass.PlayerOfferingDataNotify result) {
        if (offeringDataListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.PlayerOfferingDataNotifyOuterClass.PlayerOfferingDataNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 90: {
                emu.grasscutter.net.proto.PlayerOfferingDataOuterClass.PlayerOfferingData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.PlayerOfferingDataOuterClass.PlayerOfferingData.parser(),
                        extensionRegistry);
                if (offeringDataListBuilder_ == null) {
                  ensureOfferingDataListIsMutable();
