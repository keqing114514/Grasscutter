...
public final class FleurFairBossSettleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo result) {
        if (statInfoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.FleurFairBossSettleInfoOuterClass.FleurFairBossSettleInfo result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 90: {
                emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.parser(),
                        extensionRegistry);
                if (statInfoListBuilder_ == null) {
                  ensureStatInfoListIsMutable();
                  statInfoList_.add(m);
