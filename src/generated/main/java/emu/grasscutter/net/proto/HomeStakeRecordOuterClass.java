...
public final class HomeStakeRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.HomeStakeRecordOuterClass.HomeStakeRecord result) {
        if (recordListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.HomeStakeRecordOuterClass.HomeStakeRecord result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 74: {
                emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord m =
                    input.readMessage(
                        emu.grasscutter.net.proto.HomeStakePlayRecordOuterClass.HomeStakePlayRecord.parser(),
                        extensionRegistry);
                if (recordListBuilder_ == null) {
                  ensureRecordListIsMutable();
                  recordList_.add(m);
