...
public final class NavMeshStatsNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.NavMeshStatsNotifyOuterClass.NavMeshStatsNotify result) {
        if (infosBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.NavMeshStatsNotifyOuterClass.NavMeshStatsNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 26: {
                emu.grasscutter.net.proto.PbNavMeshStatsInfoOuterClass.PbNavMeshStatsInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.PbNavMeshStatsInfoOuterClass.PbNavMeshStatsInfo.parser(),
                        extensionRegistry);
                if (infosBuilder_ == null) {
                  ensureInfosIsMutable();
                  infos_.add(m);
