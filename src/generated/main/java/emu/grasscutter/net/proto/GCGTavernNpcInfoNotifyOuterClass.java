...
public final class GCGTavernNpcInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.GCGTavernNpcInfoNotifyOuterClass.GCGTavernNpcInfoNotify result) {
        if (unk3300FKAKHMMIEBCBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GCGTavernNpcInfoNotifyOuterClass.GCGTavernNpcInfoNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 18: {
                emu.grasscutter.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.parser(),
                        extensionRegistry);
                if (unk3300BAMLNENDLCMBuilder_ == null) {
                  ensureUnk3300BAMLNENDLCMIsMutable();
      ...
      public Builder mergeCharacterNpc(emu.grasscutter.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo value) {
        if (characterNpcBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            characterNpc_ != null &&
            characterNpc_ != emu.grasscutter.net.proto.GCGTavernNpcInfoOuterClass.GCGTavernNpcInfo.getDefaultInstance()) {
