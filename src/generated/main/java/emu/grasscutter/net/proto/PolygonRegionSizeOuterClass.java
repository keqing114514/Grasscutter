...
public final class PolygonRegionSizeOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize result) {
        if (pointListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.PolygonRegionSizeOuterClass.PolygonRegionSize result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.proto.VectorPlaneOuterClass.VectorPlane m =
                    input.readMessage(
                        emu.grasscutter.net.proto.VectorPlaneOuterClass.VectorPlane.parser(),
                        extensionRegistry);
                if (pointListBuilder_ == null) {
                  ensurePointListIsMutable();
                  pointList_.add(m);
