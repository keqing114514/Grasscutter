...
public final class CheckSegmentCRCNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.CheckSegmentCRCNotifyOuterClass.CheckSegmentCRCNotify result) {
        if (infoListBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.CheckSegmentCRCNotifyOuterClass.CheckSegmentCRCNotify result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 50: {
                emu.grasscutter.net.proto.SegmentInfoOuterClass.SegmentInfo m =
                    input.readMessage(
                        emu.grasscutter.net.proto.SegmentInfoOuterClass.SegmentInfo.parser(),
                        extensionRegistry);
                if (infoListBuilder_ == null) {
                  ensureInfoListIsMutable();
                  infoList_.add(m);
