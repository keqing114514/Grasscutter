...
public final class AISnapshotInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.AISnapshotInfoOuterClass.AISnapshotInfo result) {
        if (aiSnapshotsBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.AISnapshotInfoOuterClass.AISnapshotInfo result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData m =
                    input.readMessage(
                        emu.grasscutter.net.proto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.parser(),
                        extensionRegistry);
                if (aiSnapshotsBuilder_ == null) {
                  ensureAiSnapshotsIsMutable();
                  aiSnapshots_.add(m);
