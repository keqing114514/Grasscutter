...
public final class GCGWorldPlayerGCGStateRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(emu.grasscutter.net.proto.GCGWorldPlayerGCGStateRspOuterClass.GCGWorldPlayerGCGStateRsp result) {
        if (playerStateBuilder_ == null) {
      ...
      private void buildPartial0(emu.grasscutter.net.proto.GCGWorldPlayerGCGStateRspOuterClass.GCGWorldPlayerGCGStateRsp result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 18: {
                emu.grasscutter.net.proto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState m =
                    input.readMessage(
                        emu.grasscutter.net.proto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.parser(),
                        extensionRegistry);
                if (playerStateBuilder_ == null) {
                  ensurePlayerStateIsMutable();
                  playerState_.add(m);
